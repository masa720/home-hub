...
export function RecipeEditModal({ label, title, children }: RecipeEditModalProps) {
  ...
  return (
    <>
      ...
      >
        ...
        <div className="max-h-[70vh] overflow-y-auto p-4" onSubmit={() => setTimeout(() => dialogRef.current?.close(), 0)}>
          {children}
        </div>
      </dialog>
    </>
